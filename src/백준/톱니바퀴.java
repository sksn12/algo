...
public class 톱니바퀴 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // 1번톱니의 2번째 배열, 2번톱니의 6번째 배열
        // 2번톱니의 2번째 배열, 3번톱니의 6번째 배열
        // 3번톱니의 2번째 배열, 4번톱니의 6번째 배열

        // 시계 방향, 반시계 방향으로 배열을 바꿔주는 함수 만들기
        // 굴려야하는 톱니의 번호에따라 톱니를 변경하기전 왼쪽,오른쪽에 톱니를 굴려야하는 값 먼저 확인
        // 굴려야하는 톱니와 방향을 List에 추가
        // 확인되면 톱니 굴리기
